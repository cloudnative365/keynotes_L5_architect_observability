...
cd /etc/prometheus/
wget https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/1_prometheus/prometheus-A.yml
mv prometheus_A.yml /etc/prometheus/prometheus.yml
