...
resource "aws_instance" "jumpserver" {
  ...
  user_data = <<-EOF
        ...
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/3_nginx/init_nginx.sh|sh
        EOF
  tags =  {
    Name = "jumpserver"
  }
...
resource "aws_instance" "node1" {
  ...
  user_data = <<-EOF
        ...
        mkdir /app/src
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/1_prometheus/init_node_exporter.sh|sh
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/1_prometheus/init_prometheus_A.sh|sh
...
resource "aws_instance" "node2" {
  ...
  user_data = <<-EOF
        ...
        mkdir /app/src
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/1_prometheus/init_node_exporter.sh|sh
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/1_prometheus/init_prometheus_B.sh|sh
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/2_thanos/init_thanos.sh|sh
        curl https://raw.githubusercontent.com/cloudnative365/keynotes_L5_architect_observability/main/1_metrics/4_minio/init_minio.sh|sh
        EOF
  tags =  {
